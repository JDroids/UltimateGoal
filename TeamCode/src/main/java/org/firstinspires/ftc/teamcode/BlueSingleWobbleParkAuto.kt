...
@Autonomous(group="1")
class BlueSingleWobbleParkAuto : CommandOpMode() {
    ...
    override fun initialize() {
        ...
        detector.setTopRectangle(0.63, 0.9)
        detector.setBottomRectangle(0.67, 0.9)
        ...
        schedule(SequentialCommandGroup(
                ...
                FollowTrajectory(mecanumDrive) {
                    mecanumDrive.trajectoryBuilder(true)
                            .lineToConstantHeading(Vector2d(-45.0, 64.0 ))
                },
